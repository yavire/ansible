...
#Script de tomcat
$versionYAV = '2.2.0.1_2';


#* NombreFichero: yavireUnixTomcat6Inventory.pl
#*=========================================================
...
#*=============================================
#* Descripción:
#*    Genera el inventario de Tomcat 6
#*
#*=============================================
#*
#*
...
$ficheroInventarioDiario="yavireInv_tomcat6.data";
...
# $DIR_DATA="${INVENTARIO}/data/tomcat6/${maquina}";	
# `mkdir -p "${DIR_DATA}"` unless (-d "${DIR_DATA}"); 
# $inventorio_inst="yavireInv_tomcat6.data";
# $fichero_inventorio_inst="$DIR_DATA/$inventorio_inst"; 
# $fichero_log="${DirLog}/yavireInv_tomcat6.log";
...
#*===========================================================
   ...
   $dirFichDataDiario="$baseAgentDirUnix/inventory/data/tomcat6/$uuid/"; 
   ...
   $szFichLog="$baseAgentDirUnix/log/inventory/yavireInv_tomcat6.log";
...
while (<INVENTARIO_SEMANAL>) {	
	...
	print "VERSION; $subversionTomcat\n";
...
#*===========================================================
#* End script: yavireUnixTomcat6Inventory.pl]
#*===========================================================
