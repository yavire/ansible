...
#* NombreFichero: yavireUnixTomcat7Inventory.pl
#*=========================================================
...
#*=============================================
#* Descripción:
#*    Genera el inventario de Tomcat 7
#*
#*=============================================
#*
#*
...
$ficheroInventarioDiario="yavireInv_tomcat7.data";
...
# $DIR_DATA="${INVENTARIO}/data/tomcat7/${maquina}";	
# `mkdir -p "${DIR_DATA}"` unless (-d "${DIR_DATA}"); 
# $inventorio_inst="yavireInv_tomcat7.data";
# $fichero_inventorio_inst="$DIR_DATA/$inventorio_inst"; 
# $fichero_log="${DirLog}/yavireInv_tomcat7.log";
...
#*===========================================================
   ...
   $dirFichDataDiario="$baseAgentDirUnix/inventory/data/tomcat7/$uuid/"; 
   ...
   $szFichLog="$baseAgentDirUnix/log/inventory/yavireInv_tomcat7.log";
...
#*===========================================================
#* End script: yavireUnixTomcat7Inventory.pl]
#*===========================================================
